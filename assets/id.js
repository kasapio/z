...
// Obraz jest przechowywany w localStorage, NIE przekazujemy go przez URL
// (URL byłby zbyt długi i powodowałby błąd about:blank#blocked)
...
function toHome(){
    // Przekaż tylko parametry (bez obrazu - obraz jest w localStorage)
